...
Diver::Diver() 
{
    ...
    spray_state = false;
    spray_step = 0;
    soundPlayed = false; // Initialize the soundPlayed flag
...
{    
    ...
    YsSoundPlayer::SoundData landingSound;
    ...
    //player.Start();
    //// Load the WAV file
    //if (YSOK != landingSound.LoadWav("splash.wav"))
    //{
    //    std::cerr << "Failed to load landing sound.\n";
    //}
    //else
    //{
    //    std::cout << "Landing sound loaded successfully.\n";
    //}
